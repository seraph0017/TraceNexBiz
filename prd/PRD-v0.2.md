...
> 版本：**v0.2**（2026-05-09，基于 4 agent Round-1 review 重写）
...
> 维护人：Nathan
>
> **v0.2 关键变更**（相对 v0.1，本节唯一目的：让 reviewer 一眼看到哪些 CRITICAL/BLOCK 被处理）：
...
>
> 状态：v0.2 等待 PM/Architect/Security/Compliance 二轮 review，目标收敛到 v1.0。
...
| `GET  /api/internal/topup/by-idem-key?key=` | **崩溃恢复**：查询某 idem-key 实际状态 | — | Partner |
...
> 本文档为 v0.2。下一步：4 个 agent（PM / Architect / Security / Compliance）二轮 review。
> 若 CRITICAL = 0、HIGH ≤ 3，则升级 v1.0；否则 → v0.3。
