...
const TOAST_MAP: Record<string, ToastSpec> = {
  ...
  BIZ_VALID_BODY: { i18nKey: "errors.valid.invalid_input", severity: "warning" },
  BIZ_VALID_INPUT: { i18nKey: "errors.valid.invalid_input", severity: "warning" },
  BIZ_VALID_PATH: { i18nKey: "errors.valid.invalid_input", severity: "warning" },
  ...
  BIZ_FEATURE_NOT_WIRED: { i18nKey: "errors.feature_not_wired", severity: "info" },
